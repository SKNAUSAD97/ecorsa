                                            ...
                                            <div class="product-main-2 no-arrow">
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ url('/') }}/web/assets/images/product/category/1.jpg" id="img-1"
                                                            data-zoom-image="{{ url('/') }}/web/assets/images/product/category/1.jpg"
                                                ...
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ url('/') }}/web/assets/images/product/category/2.jpg"
                                                            data-zoom-image="{{ url('/') }}/web/assets/images/product/category/2.jpg"
                                                ...
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ url('/') }}/web/assets/images/product/category/3.jpg"
                                                            data-zoom-image="{{ url('/') }}/web/assets/images/product/category/3.jpg"
                                                ...
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ url('/') }}/web/assets/images/product/category/4.jpg"
                                                            data-zoom-image="{{ url('/') }}/web/assets/images/product/category/4.jpg"
                                                ...
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ url('/') }}/web/assets/images/product/category/5.jpg"
                                                            data-zoom-image="{{ url('/') }}/web/assets/images/product/category/5.jpg"
                                                ...
                                                <div>
                                                    <div class="slider-image">
                                                        <img src="{{ url('/') }}/web/assets/images/product/category/6.jpg"
                                                            data-zoom-image="{{ url('/') }}/web/assets/images/product/category/6.jpg"
                                            ...
                                            <div class="left-slider-image-2 left-slider no-arrow slick-top">
                                                <div>
                                                    <div class="sidebar-image">
                                                        <img src="{{ url('/') }}/web/assets/images/product/category/1.jpg"
                                        ...
                                        <div class="tab-pane fade show active" id="description" role="tabpanel">
                                            <div class="product-description">
                                                ...
                                                <div class="banner-contain nav-desh">
                                                    <img src="{{ url('/') }}/web/assets/images/vegetable/banner/14.jpg"
                                                                        ...
                                                                        <div>
                                                                            <div class="people-image people-text">
                                                                                <img alt="user" class="img-fluid "
                                                                                    src="{{ url('/') }}/web/assets/images/review/1.jpg">
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <li>
                                                                    <div class="people-box">
                                                                        <div>
                                                                            <div class="people-image people-text">
                                                                                <img alt="user" class="img-fluid "
                                                                                    src="{{ url('/') }}/web/assets/images/review/2.jpg">
                                                                            </div>
                                                                        </div>
                                                                        <div class="people-comment">
                                                                            <div class="people-name"><a
                                                                ...
                                                                <li>
                                                                    <div class="people-box">
                                                                        <div>
                                                                            <div class="people-image people-text">
                                                                                <img alt="user" class="img-fluid "
                                                                                    src="{{ url('/') }}/web/assets/images/review/3.jpg">
                                                                            </div>
                                                                        </div>
                                                                        <div class="people-comment">
                                                                            <div class="people-name"><a
                                                                ...
                                                                <li>
                                                                    <div class="people-box">
                                                                        <div>
                                                                            <div class="people-image people-text">
                                                                                <img alt="user" class="img-fluid "
                                                                                    src="{{ url('/') }}/web/assets/images/review/4.jpg">
                                                                            </div>
                                                                        </div>
                                                                        <div class="people-comment">
                                                                            <div class="people-name"><a
                                                                ...
                                                                <li>
                                                                    <div class="people-box">
                                                                        <div>
                                                                            <div class="people-image people-text">
                                                                                <img alt="user" class="img-fluid "
                                                                                    src="{{ url('/') }}/web/assets/images/review/5.jpg">
                                                                            </div>
                                                                        </div>
                                                                        <div class="people-comment">
                                                                            <div class="people-name"><a
                        ...
                        <div class="right-sidebar-box">
                            <div class="vendor-box">
                                <div class="vendor-contain">
                                    <div class="vendor-image">
                                        <img src="{{ url('/') }}/web/assets/images/product/vendor.png" class="blur-up lazyload" alt="">
                                    </div>
                                ...
                                <div class="category-menu">
                                    ...
                                    <ul class="product-list product-right-sidebar border-0 p-0">
                                        <li>
                                            <div class="offer-product">
                                                <a href="product-left-thumbnail.html" class="offer-image">
                                                    <img src="{{ url('/') }}/web/assets/images/vegetable/product/23.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                        ...
                                        <li>
                                            <div class="offer-product">
                                                <a href="product-left-thumbnail.html" class="offer-image">
                                                    <img src="{{ url('/') }}/web/assets/images/vegetable/product/24.png"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                                        ...
                                        <li>
                                            <div class="offer-product">
                                                <a href="product-left-thumbnail.html" class="offer-image">
                                                    <img src="{{ url('/') }}/web/assets/images/vegetable/product/25.png"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                                        ...
                                        <li class="mb-0">
                                            <div class="offer-product">
                                                <a href="product-left-thumbnail.html" class="offer-image">
                                                    <img src="{{ url('/') }}/web/assets/images/vegetable/product/26.png"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                            ...
                            <div class="ratio_156 pt-25">
                                <div class="home-contain">
                                    <img src="{{ url('/') }}/web/assets/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                                        alt="">
