    ...
    <section class="section-404 section-lg-space">
        <div class="container-fluid-lg">
            <div class="row">
                <div class="col-12">
                    <div class="image-404">
                        <img src="{{ url('/') }}/web/assets/images/inner-page/404.png" class="img-fluid blur-up lazyload" alt="">
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="contain-404">
                        ...
                        <a href="{{ route('/') }}"
                            class="btn btn-md text-white theme-bg-color mt-4 mx-auto">Back To Home Screen</a>
                    </div>
                </div>
            </div>
        </div>
