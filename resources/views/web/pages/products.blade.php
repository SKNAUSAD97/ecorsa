                    ...
                    <div class="slider-1 slider-animate product-wrapper no-arrow">
                        <div>
                            <div class="banner-contain-2 hover-effect">
                                <img src="{{ url('/') }}/web/assets/images/shop/1.jpg" class="bg-img rounded-3 blur-up lazyload" alt="">
                                <div
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="form-floating theme-form-floating-2 search-box">
                                                    <input type="search" onkeyup="searchCategories(event.target.value)" class="form-control" id="search"
                                                        placeholder="Search ..">
                                                    <label for="search">Search</label>
                                                </div>
                                                <ul class="category-list cat-product-count custom-padding custom-height"></ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse show">
                                            <div class="accordion-body">
                                                <div class="range-slider">
                                                    <input type="text" name="price" onchange="submitForm()" class="js-range-slider" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
